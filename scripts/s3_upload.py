...
DATA_DIR = os.environ.get("DERIVED_DATA_DIR", "data")
PREFIX = "new cool data"
...
def main():
    local_raw = Path(DATA_DIR) 
    uploader = S3Uploader(
        local_raw, bucket=S3_BUCKET, prefix=PREFIX, file_format=FILE_TYPE
    )
